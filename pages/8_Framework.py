...
with tabs[1]:
    ...
    | :--- | :--- | :--- |
    | **\\$3,000 - \\$10,000** | Spreads + Short Iron Condor | **Credit > Debit**: Selling premium harnesses high-odds win rates through extrinsic value farming (theta decay). |
    ...
    with col_r2:
        with st.container(border=True):
            ...
            * **Why the stock market always goes up in the long run:**
              ...
              - Momentum trends and herd behavior.
            * **What causes markets/stocks to drop:**
              - Leveraged margin calls
